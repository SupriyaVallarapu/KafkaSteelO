...
OPCUA_persist_blueprint= Blueprint('OPCUA_persist_blueprint', __name__)
@OPCUA_persist_blueprint.route('/api/consume_and_persist_opcua', methods=['POST'])
@cross_origin()
def consume_and_persist_opcua():
    try:
